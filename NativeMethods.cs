...
namespace ResetWindows
{
    internal static class NativeMethods
    {
        ...
        #region user32.dll and dwmapi.dll function imports; window handling

        [DllImport("dwmapi.dll")]
        internal static extern int DwmGetWindowAttribute(IntPtr hwnd, Int32 dwAttribute, ref Rectangle pvAttribute, Int32 cbAttribute);
        ...
        [DllImport("user32.dll")]
        internal static extern bool PhysicalToLogicalPointForPerMonitorDPI(IntPtr hwnd, ref Point lpRect);
